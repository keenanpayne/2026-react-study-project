...
export default function ChatPlan() {
  return (
    <aside className="flex justify-between border border-gray-300 rounded-lg px-3 py-2.5 md:max-w-[80%] my-3">
      <header className="flex flex-col gap-0.5">
        <h3 className="font-semibold">Create Social Scheduler Plan</h3>
        <p className="text-xs text-gray-500">Version 1 at <time dateTime="2026-03-29T13:36:00">Mar 29 1:36 PM</time></p>
      </header>
