  ...
  return (
    <header className="px-2.5 py-1.5 sticky top-0 left-0 bg-white dark:bg-zinc-900 z-10">
      <nav className="flex items-center gap-0.5 sm:gap-1 md:gap-1.5">
        <Button size="md" rounded="md" as="link" href="https://bolt.new" className="shrink-0 h-10">
          <img src="/bolt-logo-wordmark.png" alt="Bolt.new" className="h-6 dark:invert-100" />
        </Button>

        <Separator />

        <Button size="md" rounded="md" className="shrink-0 h-9" openChildren={<UserTeams data={teams} />}>
        ...
        <Button size="md" rounded="md" className="h-9" openChildren={<DropdownProjects />}>
